...
import io.github.racoondog.msl.settings.api.StyleSetting;
...
public class StyleSettingScreen extends WindowScreen {
    ...
    public StyleSettingScreen(GuiTheme theme, Setting<Style> setting) {
        ...
        this.color = new SettingColor(setting.get());
    }
    ...
    private void setFromSetting() {
        color.set(new SettingColor(setting.get()));
    ...
    public static void preInit() {
        SettingsWidgetFactory.registerCustomFactory(StyleSetting.class, (theme) -> (table, s) -> {
            ...
            WQuad quad = list.add(theme.quad(new SettingColor(setting.get()))).widget();
            ...
            reset.action = () -> {
                setting.reset();
                quad.color = new SettingColor(setting.get());
            };
        });
    }
}
