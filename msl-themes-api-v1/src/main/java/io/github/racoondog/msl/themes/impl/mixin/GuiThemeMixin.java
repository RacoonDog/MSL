package io.github.racoondog.msl.themes.impl.mixin;

import io.github.racoondog.msl.themes.api.RecolorGuiTheme;
import io.github.racoondog.msl.themes.impl.IGuiTheme;
...
public abstract class GuiThemeMixin implements IGuiTheme {
    ...
    @Override
    public SettingsWidgetFactory msl$getSettingsWidgetFactory() {
